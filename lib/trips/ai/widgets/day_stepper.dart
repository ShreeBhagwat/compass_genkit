        ...
        stepIconBuilder: (stepIndex, stepState) {
          if (stepIndex == activeStep) {
            return ClipRRect(
              ...
              child: widget.activities[activeStep].imageUrl.isNotEmpty
                  ? FadeInImage(
                      width: 80,
                      height: 80,
                      fit: BoxFit.cover,
                      ...
                      image:
                          NetworkImage(widget.activities[activeStep].imageUrl),
                    )
                  : const Image(
                      width: 80,
                      height: 80,
        ...
        steps: [
          ...List.generate(widget.activities.length, (index) {
            return Step(
              ...
              title: Text(
                widget.activities[index].activityTitle,
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                ),
              ),
              content: Text(widget.activities[index].activityDesc)
                  .animate()
